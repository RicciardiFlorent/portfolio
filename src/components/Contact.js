    ...
    return (
        ...
        <div class="max-w-xl mx-auto px-6 lg:px-0 ">
          <div className="flex items-center ">
            ...
            <p className="text-xl sm:text-4xl sm:w-1/2 ml-5 font-bold text-gray-100">Get In Touch</p>
          </div>
          ...
          <div className="text-center sm:items-center sm:flex flex-col">
              ...
              <a  href="mailto: florentricciardi@gmail.com" class="btn inline-block  font-bold hover:bg-red-500 hover:bg-opacity-10  px-6 py-4 border text-yellow-200 border-yellow-200 rounded">
          Contact Me!
        </a>
          </div>
        </div>
